...
export const Landing = () => {
  ...
  return (
    <LandingLayout>
      <div className="lg:hidden flex flex-col my-15 gap-5">
      ...
      <div className="hidden lg:flex self-center my-15 flex-col gap-20 px-60 items-center">
      ...
      <div className="flex lg:flex-row justify-center mb-10">
        <Button
          onClick={() => navigate('/auth/register')}
          className="bg-torange hover:text-torange hover:bg-orange-200 mx-5 py-10 text-lg lg:px-20 lg:rounded-lg"
        >
          Start for free
        </Button>
        <Button
          onClick={() => navigate('/auth/login')}
          className="hidden lg:flex bg-white text-black border border-black hover:text-white hover:bg-black py-10 text-lg px-20 box-border rounded-lg"
        >
          Log in
        </Button>
      </div>
      <Details />
      <Savings />
      <div className="hidden lg:flex flex-col py-15 items-center bg-tblue">

...
export const CreateTransactionForm = () => {
  ...
  return (
    <Drawer>
      ...
      <DrawerContent className="flex flex-col h-full items-center px-10 pb-10">
        <h2 className="my-5 font-bold text-2xl">New Transaction</h2>
        ...
        <Popover>
          <PopoverTrigger className="self-start flex flex-row gap-5 items-center bg-gray-100 border px-4 py-2 rounded-xl text-gray-500">
            SelectDate
